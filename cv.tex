...
\setromanfont[
  Path=assets/fonts/IosevkaSlabPropo/,
...
\setsansfont[
  Path=assets/fonts/IosevkaSansPropo/,
  UprightFont=*-Regular.ttf,
  BoldFont=*-Bold.ttf,
  ItalicFont=*-Italic.ttf,
  BoldItalicFont=*-BoldItalic.ttf,
...
\setmonofont[
  Path=assets/fonts/IosevkaSansFixed/,
  UprightFont=*-Regular.ttf,
  BoldFont=*-Bold.ttf,
  ItalicFont=*-Italic.ttf,
  BoldItalicFont=*-BoldItalic.ttf,
...
\newfontfamily{\IosevkaSlabPropoLight}[
  Path=assets/fonts/IosevkaSlabPropo/,
...
\newfontfamily{\IosevkaSlabPropoMedium}[
  Path=assets/fonts/IosevkaSlabPropo/,
...
\newfontfamily{\IosevkaSansPropoSemiBold}[
  Path=assets/fonts/IosevkaSansPropo/,
  UprightFont=*-SemiBold.ttf,
  ItalicFont=*-SemiBoldItalic.ttf,
  Ligatures=TeX
]{IosevkaSansPropo}
...
\newcommand\makecvheader{
  \begin{cvname}
    \scalebox{3}{\textit{\IosevkaSlabPropoLight Michele} \textbf{\IosevkaSlabPropoMedium Piazzai}}\par
    \bigskip
  ...
  \begin{minipage}{.7475\textwidth}
    ...
    \end{tabular}
  \end{minipage}
  \begin{minipage}{.2475\textwidth}
    \hfill\href{https://www.business-school.ed.ac.uk/staff/michele-piazzai}{\includesvg[width=.7475\textwidth]{assets/img/qrcode}}
  \end{minipage}
}
